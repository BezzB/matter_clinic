...
**[Vet Clinic ]** is a project that focuses on the creation of a database, and making queries to the database in matter hospital

## 🛠 Built With <a name="built-with"> Ruby om rails and PostgreSQL</a>
